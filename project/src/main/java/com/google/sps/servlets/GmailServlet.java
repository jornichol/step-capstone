...
public class GmailServlet extends HttpServlet {
    ...
    private void gmailSearch(HttpServletResponse response) throws IOException, GeneralSecurityException {
        ...
        String userId;
        List<Message> result = listMessagesMatchingQuery(service, userId, searchQuery);
        if (!result.isEmpty()){
